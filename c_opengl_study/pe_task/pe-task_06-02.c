...
void drawTri (double pos[2], double size[2], double color[3]){
    double static_pos[2];
    static_pos[0] = ((double)rand()/RAND_MAX)*2-1;
    static_pos[1] = ((double)rand()/RAND_MAX)*2-1;
